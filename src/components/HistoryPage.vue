          ...
          <div class="history-list" v-if="!isShowingPastRecords && sortedRecords.length">
            ...
            >
              ...
              <div class="record-body">
                ...
                <p v-if="record.preliminaryReviewComment" class="review-comment">
                  <span>初审意见</span>
                  {{ record.preliminaryReviewComment }}
                </p>
                <p v-if="record.finalReviewComment" class="review-comment">
                  <span>终审意见</span>
          ...
          <div class="past-record-list" v-if="isShowingPastRecords && displayedPastRecords.length">
            ...
            >
              ...
              >
                ...
                <p v-if="record.note">{{ record.note }}</p>
                <p v-if="record.preliminaryReviewComment" class="past-review-comment">
                  <span>初审意见</span>
                  {{ record.preliminaryReviewComment }}
                </p>
                <p v-if="record.finalReviewComment" class="past-review-comment">
                  <span>终审意见</span>
                  {{ record.finalReviewComment }}
                </p>
